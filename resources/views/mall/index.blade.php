    ...
    <div class="container px-5 py-5 md:pt-16 border-primary">
        ...
        <div class="w-11/12 grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-6 mx-auto">
            <div class="w-full flex justify-center">
                <div
                    class="border shadow-lg rounded-lg px-2 py-3 sm:px-3 sm:py-4 flex justify-center items-center gap-5 w-4/6 sm:w-full">
                    <i class="ri-truck-line text-lg sm:text-xl md:text-3xl"></i>
                    <div>
                        <h4 class="font-medium capitalize text-sm md:text-base lg:text-lg">Free Shipping</h4>
                        <p class="text-gray-500 text-xs md:text-sm">Order over 1.000 items</p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full flex justify-center">
                <div
                    class="border shadow-lg rounded-lg px-2 py-3 sm:px-3 sm:py-4 flex justify-center items-center gap-5 w-4/6 sm:w-full">
                    <i class="ri-percent-line text-lg sm:text-xl md:text-3xl"></i>
                    <div>
                        <h4 class="font-medium capitalize text-sm md:text-base lg:text-lg">promos</h4>
                        <p class="text-gray-500 text-xs md:text-sm">Discount everyday</p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full flex justify-center">
                <div
                    class="border shadow-lg rounded-lg px-2 py-3 sm:px-3 sm:py-4 flex justify-center items-center gap-5 w-4/6 sm:w-full">
                    <i class="ri-customer-service-line text-lg sm:text-xl md:text-3xl"></i>
                    <div>
                        <h4 class="font-medium capitalize text-sm md:text-base lg:text-lg">24/7 Support</h4>
                        <p class="text-gray-500 text-xs md:text-sm">Customer support</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            @foreach ($products1 as $recomProd)
                <div
                    ...
                    <div class="relative flex-grow flex justify-center items-center">
                        <div class="absolute top-3 left-3 sm:top-4 sm:left-4 rounded-full bg-red-500 p-[2px] md:p-1">
                    ...
                    <div class="flex flex-col pt-4 pb-3 px-4">
                        ...
                        <button id="{{ $recomProd->id }}" class="product-modal text-left flex-grow"
                            ...
                            <h4 class="uppercase font-normal text-xs sm:text-sm mb-2 text-gray-800 hover:text-primary transition">
                                {{ $recomProd->description }}</h4>
                        </button>
                        <div class="flex items-baseline justify-start mb-1 space-x-2">
                            @auth
                                <p class="text-red-500 font-semibold text-lg sm:text-xl">
                                    {{ '$' . number_format(floatval($recomProd->cost), 2, '.', ',') }}</p>
                                <p class="font-semibold text-sm sm:text-md text-gray-400 line-through">
                    ...
                    @auth
                        <button
                            ...
                            data-product-id="{{ $recomProd->id }}">Add to cart</button>
                    @else
                        <button
            ...
            @foreach ($products2 as $allProd)
                <div
                    ...
                    <div class="flex flex-col pt-4 pb-3 px-4">
                        ...
                        <!-- Modal toggle 2 -->
                        <button id="{{ $allProd->id }}" class="product-modal text-left flex-grow"
                            data-modal-target="product-modal" data-modal-toggle="product-modal">
                            <h4 class="uppercase font-normal text-xs sm:text-sm mb-2 text-gray-800 hover:text-primary transition">
