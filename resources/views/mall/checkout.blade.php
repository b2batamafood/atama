            ...
            <div class="mt-4 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    <img class="m-2 h-[105px] w-28 rounded-md object-cover object-center"
                        src="https://insitusales.s3.us-east-1.amazonaws.com/web-app/data/10127/images/products/800002E1-1688915124_AT-20002"
                        alt="" />
                    <div class="flex w-full flex-col px-4 py-4">
                        <span class="font-semibold">SFC FRUIT SODA - PLUM 4 X 6 X 350ML</span>
                        <span class="float-right text-gray-400">QTY : 1</span>
                        <p class="text-lg font-bold">$28.8</p>
                    </div>
                </div>
                <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    <img class="m-2 h-[105px] w-28 rounded-md object-cover object-center"
                        src="https://insitusales.s3.us-east-1.amazonaws.com/web-app/data/10127/images/products/80000585-1696452410_AT-30119"
                        alt="" />
                    <div class="flex w-full flex-col px-4 py-4">
                        <span class="font-semibold">CHEETOS CORN STICKS (JAPANESE STEAK FLAVOR) 50 X 60G</span>
                        <span class="float-right text-gray-400">QTY : 1</span>
                        <p class="mt-auto text-lg font-bold">$65</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col sm:flex-row">
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-semibold text-gray-900">$93.80</p>
                        </div>
                        <div class="flex items-center justify-between">
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">$104.80</p>
                    </div>
                </div>
            </div>
            <button
                class="mt-4 mb-8 w-full rounded-md bg-primary hover:brightness-75 transition ease-in-out px-6 py-3 font-medium text-white">Place
                Order</button>
        </div>
        {{-- PAYMENT DETAILS END --}}
    </div>
