<x-admin.layouts.app>
    <div class="card w-full p-6 bg-base-100 shadow-xl mt-2">
        <div class="text-xl font-semibold inline-block capitalize">Customers
            ...
            <div class="overflow-x-auto w-full">
                <table class="table w-full">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            <td class="capitalize font-bold">{{ $user->GivenName . ' ' . $user->FamilyName }}</td>
                            <td>{{ $user->CompanyName }}</td>
                            <td>{{ $user->PrimaryEmailAddr->Address ?? '' }}</td>
                            <td>{{ $user->Balance }}</td>
                            <td>
                                {{ $user->BillAddr->Line1??'N/A'.', '.
                                    optional(optional($user)->BillAddr)->City ?: 'N/A'.', '.
                                    $user->BillAddr->CountrySubDivisionCode??' '.', '.
                                    $user->BillAddr->PostalCode??' '
                                }}
                            </td>
                            {{--
