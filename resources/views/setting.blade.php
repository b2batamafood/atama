...
@section('container')
    <div class="px-10 lg:px-40 py-10 mx-auto">
        ...
        <div class="flex mb-14">
            <div class="w-1/3">
                <h1 class="capitalize font-bold text-lg">personal information</h1>
            </div>
        ...
        <div class="flex mt-14">
            <div class="w-1/3 pr-14">
                <h1 class="capitalize font-bold text-lg">change password</h1>
                <p class="text-base">Update your password associated with your account.</p>
            </div>
